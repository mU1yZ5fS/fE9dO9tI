...
const 雕像铭文 := "这尊半身像立于英灵殿中央，与头顶的金星遥相守望。\n他承载着原作的岁月记忆，经重制工程重新安放于此。\n谨代表全体开发者与玩家，向那段历史与其中的人们致意。—— 人民万岁，浩气长存。"

const 名录行 := "原作开发组 · GKchP 汉化组 · 改版制作组 · Godot 重制组 mU1yZ5fS · 全体玩家 · 以及每一位来访者"
...
func 建伟人雕像() -> void:
	...
	var _台注 := add_label(_生成区, "英灵殿中央 · 重制工程敬立 —— 按 E 阅读铭文",
