...
const BATCH1 := preload("res://场景/外交界面/外交互动_批1.gd")
const BATCH2 := preload("res://场景/外交界面/外交互动_批2.gd")
const BATCH3 := preload("res://场景/外交界面/外交互动_批3.gd")
const BATCH4 := preload("res://场景/外交界面/外交互动_批4.gd")
const BATCH5 := preload("res://场景/外交界面/外交互动_批5.gd")
const BATCH6 := preload("res://场景/外交界面/外交互动_批6.gd")
const BATCH_EXTRA := preload("res://场景/外交界面/外交互动_补遗.gd")
