...
## 自动迁移自 场景/事件界面/events/event_062_inner_mongolia_problem.tres
## 共享效果脚本（未合并进本文件）：
##   res://数据脚本/事件效果/event_053_062_reform_and_alliances.gd
## 文案见 资产/本地化/events_zh_CN.csv

const META := {
	"id": "inner_mongolia_problem",
	"num": 62,
	"priority": 620,
	"display_script": "res://数据脚本/事件效果/event_053_062_reform_and_alliances.gd",
	"trigger": [{"t": "DATE_AFTER", "key": "1979.8"}, {"t": "RESOURCE_NOT_EQUALS", "key": "war_resolve", "v": 2}],
