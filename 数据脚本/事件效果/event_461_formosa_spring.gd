...
const TXT_OPT0_DIS := "event.script.event_461_formosa_spring.c0"
const TXT_R0 := "event.script.event_461_formosa_spring.c1"
const TXT_NAME_SAR := "event.script.event_461_formosa_spring.c2"
const TXT_R1 := "event.script.event_461_formosa_spring.c3"
	...
	match opt:
		0:
			...
			if taiwan != null:
				...
				taiwan.chinese_name = tr(TXT_NAME_SAR)
			if china != null:
