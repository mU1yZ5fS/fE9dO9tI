...
func execute(context: Dictionary) -> void:
	...
	match str(context.get("event_id", "")):
		"naxalite_endgame": _event_71(option_index)
		"janata_crisis": _event_72(option_index)
		"iran_iraq_war": _event_73()
	ws.clamp_empire_relations()
	_sync_empire_mirrors()


func _event_71(option_index: int) -> void:
	match option_index:
		0:
...
func _event_72(option_index: int) -> void:
