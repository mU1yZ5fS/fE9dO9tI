...
const TXT_R4 := "event.script.event_142_peru_election_1985.c0"
const TXT_R1 := "event.script.event_142_peru_election_1985.c1"
const TXT_R6 := "event.script.event_142_peru_election_1985.c2"
const TXT_RESULT_NAME := "event.script.event_142_peru_election_1985.c3"
const TXT_FRIEND := "event.script.event_142_peru_election_1985.c4"
const TXT_ENEMY := "event.script.event_142_peru_election_1985.c5"
...
func execute(context: Dictionary) -> void:
	...
	context["result_title"] = tr(TXT_RESULT_NAME)
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_142_peru_election_1985.tres
...
const META := {
	...
	"priority": 14200,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_142_peru_election_1985.gd",
