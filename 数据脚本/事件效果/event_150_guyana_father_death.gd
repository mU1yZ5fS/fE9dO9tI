...
const TXT_OPT1_B := "event.script.event_150_guyana_father_death.c0"
const TXT_OPT2_DIS := "event.script.event_150_guyana_father_death.c1"
const TXT_R7 := "event.script.event_150_guyana_father_death.c2"
const TXT_R1 := "event.script.event_150_guyana_father_death.c3"
const TXT_R8 := "event.script.event_150_guyana_father_death.c4"
const TXT_R9 := "event.script.event_150_guyana_father_death.c5"
const TXT_FRIEND := "event.script.event_150_guyana_father_death.c6"
const TXT_ENEMY := "event.script.event_150_guyana_father_death.c7"
...
func execute(context: Dictionary) -> void:
	...
	if c.sub_government == GameConstants.SubGovernment.NEO_FASCIST:
		...
		context["result_text"] = tr(TXT_R9) + _friend_suffix(c)



# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_150_guyana_father_death.tres
...
const META := {
	...
	"priority": 15000,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_150_guyana_father_death.gd",
