...
const TXT_R1 := "event.script.event_151_suriname_newborn_state.c0"
const TXT_R8 := "event.script.event_151_suriname_newborn_state.c1"
const TXT_R9 := "event.script.event_151_suriname_newborn_state.c2"
const TXT_FRIEND := "event.script.event_151_suriname_newborn_state.c3"
const TXT_ENEMY := "event.script.event_151_suriname_newborn_state.c4"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_151_suriname_newborn_state.tres
...
const META := {
	...
	"priority": 15100,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_151_suriname_newborn_state.gd",
