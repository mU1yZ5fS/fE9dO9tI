...
func _winter_result_0(context: Dictionary) -> void:
	...
	_add_data(W.I_AGENTS, -50)                # Event460.cs:55  data[9] -= 50
	_add_data(W.I_ARMY, -100)                 # Event460.cs:56  data[22] -= 100
	_add_data(W.I_DIPLO, 10)                  # Event460.cs:57  data[6] += 10
...
func _winter_result_1(context: Dictionary) -> void:
	...
	_add_data(W.I_DIPLO, 5)                   # Event460.cs:67  data[6] += 5
...
func _spring_result_0(context: Dictionary) -> void:
	...
	_add_data(W.I_PARTY_SUPPORT, 300)          # Event461.cs:67  data[1] += 300
	_add_data(W.I_PEOPLE_SUPPORT, 300)         # Event461.cs:68  data[3] += 300
	_add_data(W.I_BUDGET, -100)                # Event461.cs:69  data[8] -= 100
	_add_data(W.I_AGENTS, -100)                # Event461.cs:70  data[9] -= 100
	...
	if taiwan != null:
		...
		if china != null:
			...
			if china.has_tag("ovd"):           # Event461.cs:93-96
				taiwan.set_tag("ovd", true)
	_add_data(W.I_PARTY_SUPPORT, 200)          # Event461.cs:97  data[1] += 200
	_add_data(W.I_PEOPLE_SUPPORT, 100)         # Event461.cs:98  data[3] += 100
	_add_data(W.I_BUDGET, -50)                 # Event461.cs:99  data[8] -= 50
	_add_data(W.I_AGENTS, -50)                 # Event461.cs:100 data[9] -= 50
