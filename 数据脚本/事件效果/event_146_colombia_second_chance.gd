...
const TXT_OPT3_DIS := "event.script.event_146_colombia_second_chance.c0"
const TXT_R6 := "event.script.event_146_colombia_second_chance.c1"
const TXT_R6_DEAD := "event.script.event_146_colombia_second_chance.c2"
const TXT_R7 := "event.script.event_146_colombia_second_chance.c3"
const TXT_R4 := "event.script.event_146_colombia_second_chance.c4"
const TXT_R1 := "event.script.event_146_colombia_second_chance.c5"
const TXT_FRIEND := "event.script.event_146_colombia_second_chance.c6"
const TXT_ENEMY := "event.script.event_146_colombia_second_chance.c7"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_146_colombia_second_chance.tres
...
const META := {
	...
	"priority": 14600,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_146_colombia_second_chance.gd",
