...
## 原作 Event85.cs：哈萨克斯坦的德意志族自治区（1979.6 后 且 苏 now_leader==0 且 result[84]==0 或 data[149]==2）。
## 触发：TimeScript.cs:10698。效果（Event85.cs ResultsOfEvents）：
##  - result0（煽动）：data[9]-=100、leaders[3](安德罗波夫).support-=1、data[1]+=50、data[149]=3
##  - result1（预警）：苏关系>=500 → data[9]-=30、leaders[3].support-=1、data[149]=3；否则仅 data[9]-=30
##  - result2（留到将来）：无效果
