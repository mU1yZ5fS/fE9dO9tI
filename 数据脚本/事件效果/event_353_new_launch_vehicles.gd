...
const TXT_OPT0 := "event.script.event_353_new_launch_vehicles.c0"
const TXT_OPT0_DIS := "event.script.event_353_new_launch_vehicles.c1"
const TXT_OPT1 := "event.script.event_353_new_launch_vehicles.c2"
const TXT_OPT1_DIS := "event.script.event_353_new_launch_vehicles.c3"
const TXT_OPT2 := "event.script.event_353_new_launch_vehicles.c4"

const TXT_R0 := "event.script.event_353_new_launch_vehicles.c5"
const TXT_R1 := "event.script.event_353_new_launch_vehicles.c6"
const TXT_R2 := "event.script.event_353_new_launch_vehicles.c7"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_353_new_launch_vehicles.tres
...
const META := {
	...
	"priority": 35300,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_353_new_launch_vehicles.gd",
	"trigger": [{"t": "DATE_AFTER", "key": "1978.6.12"}, {"t": "NOT", "c": [{"t": "PREV_EVENT_RESULT_IS", "v": 3, "ref": "event_352"}]}],
