...
const TXT_OPT0 := "很明显，改进火炮能解决我们的问题！"
const TXT_OPT1 := "122工程是我们值得借鉴的东西"
const TXT_OPT2 := "我们可以买点其他国家的坦克吗？"
