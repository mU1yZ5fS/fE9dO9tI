...
const TXT_R0 := "event.script.event_470_which_east_is_red.c0"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_470_which_east_is_red.tres
...
const META := {
	...
	"priority": 47000,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_470_which_east_is_red.gd",
