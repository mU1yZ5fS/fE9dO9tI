...
## 原作 Event509.cs：黄金海岸的再革命？——第一幕（4选项）。 ## 触发来源见 .tres 与脚本头。文本逐字对齐原版（去空格/ 换行/剥 color）。 ## 选项显隐由 prepare 动态改写；result_text 由本脚本动态生成。

const TXT_OPT0_DIS := "event.script.event_509_ghana_revolution_act1.c0"
const TXT_OPT1_DIS := "event.script.event_509_ghana_revolution_act1.c1"
const TXT_OPT2_DIS := "event.script.event_509_ghana_revolution_act1.c2"
const TXT_R0_A := "event.script.event_509_ghana_revolution_act1.c3"
const TXT_R1_A := "event.script.event_509_ghana_revolution_act1.c4"
const TXT_R1_B := "event.script.event_509_ghana_revolution_act1.c5"
const TXT_R2_A := "event.script.event_509_ghana_revolution_act1.c6"
const TXT_R3_A := "event.script.event_509_ghana_revolution_act1.c7"
...
# ══════════════════════════════════════════════════════════ # 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_509_ghana_revolution_act1.tres # 文案不在本文件，见 资产/本地化/events_zh_CN.csv # ══════════════════════════════════════════════════════════
const META := {
	"id": "event_509",
	"num": 509,
	"priority": 50900,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_509_ghana_revolution_act1.gd",
	"trigger": [{"t": "DATE_AFTER", "key": "1979.11.27"}],
