...
const TXT_OPT2_DIS := "event.script.event_148_venezuela_repeat_mistake.c0"
const TXT_R4 := "event.script.event_148_venezuela_repeat_mistake.c1"
const TXT_R8 := "event.script.event_148_venezuela_repeat_mistake.c2"
const TXT_R1 := "event.script.event_148_venezuela_repeat_mistake.c3"
const TXT_FRIEND := "event.script.event_148_venezuela_repeat_mistake.c4"
const TXT_ENEMY := "event.script.event_148_venezuela_repeat_mistake.c5"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_148_venezuela_repeat_mistake.tres
...
const META := {
	...
	"priority": 14800,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_148_venezuela_repeat_mistake.gd",
