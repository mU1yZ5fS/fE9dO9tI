...
const TXT_IDX_1197 := "event.script.event_404_labour_split.c0"
const TXT_IDX_1192 := "event.script.event_404_labour_split.c1"
const TXT_IDX_1193 := "event.script.event_404_labour_split.c2"
const TXT_IDX_592 := "event.script.event_404_labour_split.c3"
const TXT_IDX_593 := "event.script.event_404_labour_split.c4"
const TXT_IDX_594 := "event.script.event_404_labour_split.c5"
const TXT_IDX_1194 := "event.script.event_404_labour_split.c6"
const TXT_IDX_566 := "event.script.event_404_labour_split.c7"
const TXT_IDX_567 := "event.script.event_404_labour_split.c8"
const TXT_IDX_1196 := "event.script.event_404_labour_split.c9"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_404_labour_split.tres
...
const META := {
	...
	"priority": 40400,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_404_labour_split.gd",
