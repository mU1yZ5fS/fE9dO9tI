...
const TXT_R3 := "event.script.event_143_ecuador_oligarchy_end.c0"
const TXT_R5 := "event.script.event_143_ecuador_oligarchy_end.c1"
const TXT_R6 := "event.script.event_143_ecuador_oligarchy_end.c2"
const TXT_FRIEND := "event.script.event_143_ecuador_oligarchy_end.c3"
const TXT_ENEMY := "event.script.event_143_ecuador_oligarchy_end.c4"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_143_ecuador_oligarchy_end.tres
...
const META := {
	...
	"priority": 14300,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_143_ecuador_oligarchy_end.gd",
