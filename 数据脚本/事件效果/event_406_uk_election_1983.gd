...
const TXT_IDX_1198 := "event.script.event_406_uk_election_1983.c0"
const TXT_IDX_1199 := "event.script.event_406_uk_election_1983.c1"
const TXT_IDX_1192 := "event.script.event_406_uk_election_1983.c2"
const TXT_IDX_1200 := "event.script.event_406_uk_election_1983.c3"
const TXT_IDX_1287 := "event.script.event_406_uk_election_1983.c4"
const TXT_IDX_1201 := "event.script.event_406_uk_election_1983.c5"
const TXT_IDX_1453 := "event.script.event_406_uk_election_1983.c6"
const TXT_IDX_1202 := "event.script.event_406_uk_election_1983.c7"
const TXT_IDX_1203 := "event.script.event_406_uk_election_1983.c8"
	...
	if flag and num >= 3 and flag2 and uk != null and uk.有驻军基地:
		...
		if uk != null and not uk.内战中:
			...
			if c86 != null and c86.has_tag("soc_eu"):
				...
				context["result_text"] = tr(TXT_IDX_1201) + tr(TXT_IDX_1453)
			else:
				context["result_text"] = tr(TXT_IDX_1201)
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_406_uk_election_1983.tres
...
const META := {
	...
	"priority": 40600,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_406_uk_election_1983.gd",
	"trigger": [{"t": "DATE_AFTER", "key": "1983.5.20"}],
