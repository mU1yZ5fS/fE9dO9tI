...
const TXT_R0 := "event.script.event_138_paraguay_stroessner_fall.c0"
const TXT_R1 := "event.script.event_138_paraguay_stroessner_fall.c1"
const TXT_FRIEND := "event.script.event_138_paraguay_stroessner_fall.c2"
const TXT_ENEMY := "event.script.event_138_paraguay_stroessner_fall.c3"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_138_paraguay_stroessner_fall.tres
...
const META := {
	...
	"priority": 13800,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_138_paraguay_stroessner_fall.gd",
