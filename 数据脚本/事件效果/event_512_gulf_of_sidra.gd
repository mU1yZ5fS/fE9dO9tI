...
const TXT_TITLE := "锡德拉湾事件"
const TXT_DESC := "1969年8月31日，穆阿迈尔·卡扎菲上校发动政变成为利比亚的国家领导人，之后推行敌视美国等西方国家的政策，1970年收回美国在利比亚的惠勒斯空军基地并赶走当中的美军，1972年又宣布废除前政府和美国所有的合作项目并把两国关系由大使级降格为代办级。1973年，第四次中东战争当中美国军事援助以色列，此事进一步激怒卡扎菲，他宣布利比亚以北的锡德拉湾是利比亚领海，外国船只和飞机不得进入，但此事并未得到以美国为首的西方国家认可，而只认可距离利比亚北部沿岸12海里的范围内才是利比亚领海。\n同志，据我们外务人事的最新情报，美国将在锡德拉湾开展一次突袭，彻底打消卡扎菲的念头，我们应该做点什么？"
...
const TXT_OPT0 := "我们支持卡扎菲的主张"
const TXT_OPT0_DIS := "为什么？为什么！"
const TXT_OPT1 := "我们支持美国"
const TXT_OPT1_DIS := "别和帝国主义者走这么近！"
const TXT_OPT2 := "火上浇油，轰炸利比亚！"
const TXT_OPT2_DIS := "我们不能这么做"
const TXT_OPT3 := "什么都不要做，顺其自然。"
