...
const TXT_TITLE := "黎巴嫩，你可还好"

const TXT_DESC := "自1975射向巴士的第一枪开始，整个国家脆弱的和平被彻底打破。宛如玻璃器皿的东地中海巴黎被撕下繁荣的面纱，狠狠地摔在了地上。数不尽的冲突、积压许久的仇恨覆压了古尔奈特的圣树，而皑皑白雪下是望不到头的尸骨。马龙派、逊尼派、什叶派、德鲁兹、亚美尼亚、巴勒斯坦……小小的十万平米分出了许多个派系，而生活在此的人们于分裂的漩涡中痛苦地撕裂自己。然而，现在巴勒斯坦问题的和平收场使得盘踞在这个国家的数十万巴勒斯坦人即将回归，而内战的局面也再一次发生深刻变化。也许，是时候结束这场旷日已久的兄弟之争，让雪松再一次生长在各群体的团结之壤上？"

const TXT_OPT0 := "我们将促成全国和解，宗教冲突不应该出现在二十世纪！"
const TXT_OPT0_DIS := "巴勒斯坦人不会离开"
const TXT_OPT1 := "让复兴党人和巴解组织动手，夺取最终胜利"
const TXT_OPT1_DIS_0 := "黎巴嫩人民的幸福不能依赖于一帮军阀"
const TXT_OPT1_DIS_ELSE := "你说，最初是哪个国家最先干涉黎巴嫩内战呢？"
const TXT_OPT2 := "我们将支持共产主义者夺权抵抗阵线，向烈士广场前进！"
const TXT_OPT2_DIS := "这场战争不就是左派挑起的？"
const TXT_OPT3 := "现在并不是解决内战的最好时机……"
