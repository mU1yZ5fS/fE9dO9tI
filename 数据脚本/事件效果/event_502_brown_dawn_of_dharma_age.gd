...
## 原作 Event502.cs：末法时代的黄褐色黎明（5选项）。 ## 触发来源见 .tres 与脚本头。文本逐字对齐原版（去空格/ 换行/剥 color）。 ## 选项显隐由 prepare 动态改写；result_text 由本脚本动态生成。

const TXT_OPT3_DIS := "event.script.event_502_brown_dawn_of_dharma_age.c0"
const TXT_R0_A := "event.script.event_502_brown_dawn_of_dharma_age.c1"
const TXT_R1_A := "event.script.event_502_brown_dawn_of_dharma_age.c2"
const TXT_R2_A := "event.script.event_502_brown_dawn_of_dharma_age.c3"
const TXT_R3_A := "event.script.event_502_brown_dawn_of_dharma_age.c4"
const TXT_R4_A := "event.script.event_502_brown_dawn_of_dharma_age.c5"
...
# ══════════════════════════════════════════════════════════ # 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_502_brown_dawn_of_dharma_age.tres # 文案不在本文件，见 资产/本地化/events_zh_CN.csv # ══════════════════════════════════════════════════════════
const META := {
	"id": "event_502",
	"num": 502,
	"priority": 50200,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_502_brown_dawn_of_dharma_age.gd",
	"trigger": [{"t": "ALL", "c": [{"t": "PREV_EVENT_DONE", "ref": "event_94"}, {"t": "PREV_EVENT_RESULT_IS", "ref": "event_94"}, {"t": "RESOURCE_AT_MOST", "key": "party_system", "v": 7}]}],
