...
const TXT_OPT0 := "区域要自主，民族要自治。我们有必要在实现自由的同时兼具平衡性。"
const TXT_OPT0_DIS := "美帝国主义的种族隔离政策不准通过！"
const TXT_OPT1 := "正本清源，是时候回归中华苏维埃共和国时代的“民族联邦”理想了。"
const TXT_OPT1_DIS := "照抄苏联模式是走不远的，得脚踏实地！"
const TXT_OPT2 := "有中国特色的联邦制？联邦之形？单一之实？听起来很不错！"
const TXT_OPT2_DIS_FAR := "开弓没有回头路，我们已经走得太远！此时对选择撤退就是政治自杀！"
const TXT_OPT2_DIS_LIE := "我们怎么能欺骗人民呢！"
const TXT_OPT3 := "悬崖勒马，为时不晚。中国的组织与民族问题早在50年代便被一劳永逸解决了！我们何必自找麻烦？！"
