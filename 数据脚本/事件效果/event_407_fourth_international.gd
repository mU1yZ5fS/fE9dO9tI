...
const TXT_IDX_1204 := "event.script.event_407_fourth_international.c0"
const TXT_IDX_1205 := "event.script.event_407_fourth_international.c1"
const TXT_IDX_1206 := "event.script.event_407_fourth_international.c2"
const TXT_IDX_592 := "event.script.event_407_fourth_international.c3"
const TXT_IDX_593 := "event.script.event_407_fourth_international.c4"
const TXT_IDX_594 := "event.script.event_407_fourth_international.c5"
const TXT_IDX_566 := "event.script.event_407_fourth_international.c6"
const TXT_IDX_567 := "event.script.event_407_fourth_international.c7"
const TXT_IDX_1207 := "event.script.event_407_fourth_international.c8"
const TXT_IDX_1208 := "event.script.event_407_fourth_international.c9"
const TXT_IDX_1209 := "event.script.event_407_fourth_international.c10"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_407_fourth_international.tres
...
const META := {
	...
	"priority": 40700,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_407_fourth_international.gd",
	"trigger_script": "res://数据脚本/事件效果/event_407_fourth_international.gd",
