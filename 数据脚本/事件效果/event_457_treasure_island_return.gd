...
const TXT_R0 := "event.script.event_457_treasure_island_return.c0"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_457_treasure_island_return.tres
...
const META := {
	...
	"priority": 45700,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_457_treasure_island_return.gd",
