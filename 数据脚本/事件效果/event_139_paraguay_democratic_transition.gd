...
const TXT_OPT2 := "event.script.event_139_paraguay_democratic_transition.c0"
const TXT_OPT2_LEFT := "event.script.event_139_paraguay_democratic_transition.c1"
const TXT_R7 := "event.script.event_139_paraguay_democratic_transition.c2"
const TXT_R6 := "event.script.event_139_paraguay_democratic_transition.c3"
const TXT_R4 := "event.script.event_139_paraguay_democratic_transition.c4"
const TXT_R3 := "event.script.event_139_paraguay_democratic_transition.c5"
const TXT_FRIEND := "event.script.event_139_paraguay_democratic_transition.c6"
const TXT_ENEMY := "event.script.event_139_paraguay_democratic_transition.c7"
...
func prepare(event_def: EventDef, world: WorldState) -> void:
	...
	if left:
		...
		_enable(event_def.options[2], tr(TXT_OPT2))
...
func execute(context: Dictionary) -> void:
	...
	if c.sub_government == GameConstants.SubGovernment.LIBERAL:
		...
		_add_power(EmpireData.USA, -5)
		_add_power(EmpireData.USSR, -5)
		context["result_text"] = tr(TXT_R6) + _friend_suffix(c)
		return
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_139_paraguay_democratic_transition.tres
...
const META := {
	...
	"priority": 13900,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_139_paraguay_democratic_transition.gd",
