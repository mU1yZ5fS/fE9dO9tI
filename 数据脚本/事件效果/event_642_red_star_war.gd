...
const TXT_TITLE := "红星照我去战斗"
const TXT_DESC := "华国锋同志，是时候了，当你做出这个决定的时候就表明您已经下定了决心。总参谋部提出了诸多计划，其中都旨在各个阵线上或多或少的挫败我们的敌人。这是其中的一些计划，还请您过目……"
const TXT_OPT0 := "中南半岛是迫在眉睫的问题"
const TXT_OPT0_DIS := "我们用四百亿买到了值得的东西"
const TXT_OPT1 := "跨过鸭绿江！"
