...
##   proprc/okb→亲中/okb 标签；ingamewars[70] 未建模 WarDef → 兜底创建后补名。

const TXT_TITLE := "若列宁可见今日"
...
const TXT_OPT0 := "以眼还眼：我们将把伊犁与哈尔滨变为东方的西柏林"
const TXT_OPT0_DIS := "我们可没本钱安置这么多人"
const TXT_OPT1 := "以牙还牙：为什么不把战线向北推呢？……"
const TXT_OPT1_DIS := "我们真做好了同有核国家开战的打算？"
const TXT_OPT2 := "让苏联人自己应付那些麻烦罢"
