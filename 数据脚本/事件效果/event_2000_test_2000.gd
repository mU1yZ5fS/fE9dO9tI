...
const TXT_OPT := "event.script.event_2000_test_2000.c0"
const TXT_R := "event.script.event_2000_test_2000.c1"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_2000_test_2000.tres
...
const META := {
	...
	"priority": 200000,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_2000_test_2000.gd",
