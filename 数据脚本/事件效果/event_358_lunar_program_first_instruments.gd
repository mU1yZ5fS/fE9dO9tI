...
const TXT_OPT0 := "event.script.event_358_lunar_program_first_instruments.c0"
const TXT_OPT0_DIS := "event.script.event_358_lunar_program_first_instruments.c1"
const TXT_OPT1 := "event.script.event_358_lunar_program_first_instruments.c2"

const TXT_R0 := "event.script.event_358_lunar_program_first_instruments.c3"
const TXT_R1 := "event.script.event_358_lunar_program_first_instruments.c4"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_358_lunar_program_first_instruments.tres
...
const META := {
	...
	"priority": 35800,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_358_lunar_program_first_instruments.gd",
	"trigger": [{"t": "DATE_AFTER", "key": "1980.6.1"}, {"t": "TECH_UNLOCKED", "v": 31}, {"t": "PREV_EVENT_NOT_DONE", "ref": "event_359"}],
