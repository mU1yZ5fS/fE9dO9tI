...
const TXT_R7 := "event.script.event_140_paraguay_dictator_eternal.c0"
const TXT_R9 := "event.script.event_140_paraguay_dictator_eternal.c1"
const TXT_R_FALLBACK := "event.script.event_140_paraguay_dictator_eternal.c2"
const TXT_FRIEND := "event.script.event_140_paraguay_dictator_eternal.c3"
const TXT_ENEMY := "event.script.event_140_paraguay_dictator_eternal.c4"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_140_paraguay_dictator_eternal.tres
...
const META := {
	...
	"priority": 14000,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_140_paraguay_dictator_eternal.gd",
