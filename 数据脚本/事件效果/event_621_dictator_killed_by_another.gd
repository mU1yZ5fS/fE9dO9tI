...
const TXT_TITLE := "一个独裁者将会被另一个独裁者杀死"
const TXT_DESC := "自1968年独立以来，赤道几内亚便一直处于马西埃·恩圭马的统治。在其治下，知识分子大量被屠杀，以芳族为尊并屠杀和排斥其他民族。在1979年6月，由于军队欠饷，数十个军官要求支付薪水却惨遭马西埃杀害，马西埃的侄子，国防副部长奥比昂·恩圭马因此策划了一场政变试图推翻马西埃的统治，但是失败了。不过马西埃并未发现奥比昂是政变策划者。之后马西埃谋杀了他的数个家人，其中就包括奥比昂的兄弟。此举导致了赤道几内亚执政核心圈子的恐慌，有传闻奥比昂即将发动政变推翻马西埃。在此关键时刻，我们可以选择帮助奥比昂来推翻马西埃；如果我们真的很想和马西埃拉近关系的话，也可以帮助他稳定政权；以及，我们或许可以借助周边邻国的法军力量来平定这个西非的小黑斑？"
const TXT_OPT0 := "支持奥比昂"
const TXT_OPT0_DIS := "为什么要帮助独裁者的亲戚？"
const TXT_OPT1 := "帮助马西埃"
const TXT_OPT1_DIS := "为什么要协助这个疯子？"
const TXT_OPT2 := "电话请转给爱丽舍宫"
const TXT_OPT2_DIS := "我们为何要帮助帝国主义者进行侵略？"
const TXT_OPT3 := "赤道几内亚？这个国家在哪里？"
