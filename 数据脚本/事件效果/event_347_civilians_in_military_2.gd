...
const TXT_R0 := "event.script.event_347_civilians_in_military_2.c0"
const TXT_R1 := "event.script.event_347_civilians_in_military_2.c1"
...
# ══════════════════════════════════════════════════════════
# 自动迁移的事件定义 —— 源： 场景/事件界面/events/event_347_civilians_in_military_2.tres
...
const META := {
	...
	"priority": 34700,
	"notify": false,
	"display_script": "res://数据脚本/事件效果/event_347_civilians_in_military_2.gd",
