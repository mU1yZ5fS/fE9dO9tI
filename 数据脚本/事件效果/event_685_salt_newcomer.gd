...
const TXT_OPT0 := "定好去日内瓦的专机，我将带领中国加入“战略武器限制谈判”机制"
const TXT_OPT0_DIS := "走三和外交的黑线？我们绝不允许！"
const TXT_OPT1 := "“战略武器限制谈判”？有意思。不过我们尽快适应新游戏下新规则，得用些特殊解法……"
const TXT_OPT1_DIS := "我们可没那功夫搞特殊！"
const TXT_OPT2 := "告诉他们，由于超级大国在相关问题上缺乏诚意，中国无意参与类似机制。"
