...
const TXT_TITLE := "赤道几内亚唯一天才"
const TXT_DESC := "自1968年马西埃·恩圭马成为新独立的赤道几内亚总统之后，便受朝鲜影响，将赤道几内亚民众理念改组为全国统一劳动党，并宣称赤道几内亚正在进行社会主义建设。同样作为社会主义国家的我们自然应当为赤道几内亚的同志进行正确的指导。"
const TXT_OPT0 := "是时候帮助赤道几内亚的同志了！"
const TXT_OPT1 := "你疯了吗？你明明知道马西埃根本就是个精神病"
