...
const TXT_TITLE := "和平利剑"
const TXT_DESC := "主席同志，得益于我国两弹一星工程的推进，我国60年代的核武器与导弹事业发展神速。但由于我国核武器起步晚，导弹投送能力的不足导致我国以反导工程为主，不过也取得了如同先锋级洲际导弹防御炮和一系列战略预警系统这样的成果。随着这几年国内经济的显著发展和周边国际环境的明显改善。我们是否应该转变我们原先的核武器发展战略？当然，您可以选择继续深化原来的方针，亦或我们下个大血本，两者都要？"
const TXT_OPT0 := "我们坚决不搞霸权主义，坚持毛主席的核武器防御战略方针"
const TXT_OPT1 := "为了更好的保卫革命，我们必须完全震慑敌人！"
const TXT_OPT2 := "两手抓才能更好地保卫革命！"
const TXT_OPT3 := "和平与发展才是当今的潮流，再说我们当下实在拮据……"
