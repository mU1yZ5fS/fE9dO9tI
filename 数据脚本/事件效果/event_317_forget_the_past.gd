...
const TXT_TITLE := "忘却过去？"
const TXT_DESC := "距日本在我国领土上犯下桩桩罪行已过去40多年了。当然，这些罪行都称得上是人间悲剧，但我们赢了，战犯们在审判中被判有罪，日本政府已与从前大不相同了。为了两国之间的稳定和友好关系，是时候原谅他们过去所有的罪行了。但这一决定在党和人民内非常不受欢迎。"
const TXT_OPT0 := "罪行刻骨铭心！"
const TXT_OPT1 := "我们的友谊与共同繁荣要比过去更加重要。"
